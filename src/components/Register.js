...
class Register extends Component {
    ...
    this.state={
        ...
        email:'',
        password:'',
        arr:JSON.parse(localStorage.getItem("users"))?JSON.parse(localStorage.getItem("users")):[],
        mssgname:'',mssgpas:'',mssglength:''
        }
        }
        check =async(e)=>{
    ...
    return (
      <div className='register'> 
            ...
            <form className="form-container" onSubmit={this.check}>
                <h2 style={{fontFamily: 'sans-serif'}}>Sign Up</h2><br/>
               ...
               <h6 style={{color:'red'}}>{this.state.mssglength}</h6><br/>

               <input type='text' placeholder="ConfirmPass" name='confirmpass' required/>
